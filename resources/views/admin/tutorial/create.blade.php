                         ...
                         <form class="form-group"  method="post" action="{{ url('/creartutorial') }}">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="text" name="tituloTutorial" placeholder="Titulo del tutorial..." autocomplete="off">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-12">   
                                    ...
                                    <div id="txtEditor">
                                        ...
                                        <textarea id="myTextArea" class="form-control" name="contenidoTutorial" placeholder="Titulo del tutorial..." autocomplete="off"></textarea >
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <button style="float:right" type="submit" class="btn btn-primary">Crear Tutorial</button>
                            <br>
                        </form>
                </div>
