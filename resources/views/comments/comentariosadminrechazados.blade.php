...
<main class="app-content">
	<div class="app-title">
		<div>
			<h1><i class="fa fa-dashboard"></i> Comentarios Rechazados</h1>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="tile">
				...
				<strong>Comentarios Rechazados totales: </strong>{{ $comentarios_cantidad }}
				@include('pagination', ['paginator' => $comentarios])
