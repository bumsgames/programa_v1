			...
			<div class="tile">
                ...
                <form action="/encuestas/editar/{{$encuesta->id}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 offset-lg-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$encuesta->nombre}}" class="form-control" name="titulo" id="titulo" required>
                            </div>
                            <div class="form-group poll_options_add">
                                <label for=""></label>
                                <div id="opciones">
                                    @foreach($encuesta->Options as $option)
                                    <div class="input-group input-group-lg" id="opcion_v{{$option->id}}">
                                        <input type="text" name="opcion_v" value="{{$option->nombre}}" class="form-control" readonly>
                                        <input type="color" name="col_nom_v" value="{{$option->color}}" style="height:auto;" disabled>
                    ...
                    <div style="text-align:center;">
                        <button  class="btn btn-primary" type="submit" id="agregar_encuesta">Editar Encuesta</button>
                    </div>
                </form>
			</div>
	    </div>
