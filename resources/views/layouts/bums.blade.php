  ...
  <li><a class="dropdown-item" href="configurar_tu_user"><i class="fa fa-cog fa-lg"></i> Configurar</a></li>
            ...
            <aside class="app-sidebar">
              <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" 
                src="{{ url('img/'.Auth::user()->image) }}" 
                alt="User Image" width="50" height="52">
                <div>
            ...
            <li><a class="app-menu__item" href="/pago_cliente"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Pago de Clientes &nbsp @if(isset($pago_sin_confirmar))
