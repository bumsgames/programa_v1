...
<div class="shadow_ligero" style="background-color: white;" >
	<div class="" style="padding-top: 10px; padding-bottom: 10px; background: rgb(168,169,180);
		...
		<div class="row">
			<div class="col-12 col-lg-4">
				<div class="list-group" id="list-tab" role="tablist">
					<a class="list-group-item list-group-item-action ayuda-item active" id="list-digital-list" data-toggle="list" href="#comoComprar" role="tab" aria-controls="digital">¿Como comprar en BumsGames?</a>
					<a class="list-group-item list-group-item-action ayuda-item" id="list-digital-list" data-toggle="list" href="#list-digital" role="tab" aria-controls="digital">¿Que es un juego digital?</a>
			...
			<div class="col-12 col-lg-8">
				<div class="tab-content letraNegra ayudabody" id="nav-tabContent">
					<div class="tab-pane fade show active" id="comoComprar" role="tabpanel" aria-labelledby="list-digital-list">
						<center class="fondo-titulo-ayuda">
							<h1 class="titulo-ayuda">¿Como comprar en BumsGames?</h1>
						</center>
						<br>
						<br>
						<p> 
					...
					<div class="tab-pane fade" id="list-digital" role="tabpanel" aria-labelledby="list-digital-list">
						<center class="fondo-titulo-ayuda">
